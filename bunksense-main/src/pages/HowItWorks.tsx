...
import { 
  ArrowRight, UserPlus, BookOpen, Calculator, Calendar, LineChart, Sparkles
} from "lucide-react";
...
const steps = [
  ...
  },
  {
    n: "06",
    icon: Sparkles,
    title: "Consult the AI Advisor & Insights",
    body: "Use the AI chatbot for custom recovery guidance, and check your Weekly Insights calendar to plan safe and critical skip days.",
    detail: "Everything works automatically on our secure servers, with built-in backup math options.",
  },
];
      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="container relative py-20 md:py-28 text-center max-w-3xl">
          ...
          <h1 className="font-display text-5xl md:text-6xl text-balance leading-[1.05]">
            From chaos to <span className="italic text-primary">clarity</span> in six steps.
          </h1>
